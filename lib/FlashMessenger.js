 ...
 * @param {int|null} [options.removeAfter = 8] Time (in seconds) after message item will be removed form the container.
...
export default class FlashMessenger {
    ...
    _attachRemoveEvent(removeAfter) {
        let intervals = [],
            items = this._container.el.querySelectorAll('div'),
            self = this;
